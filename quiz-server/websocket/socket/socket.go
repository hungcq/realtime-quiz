...
func NotifyScoreUpdated(quizId models.QuizId, username models.Username, leaderboard []models.UserScore) {
	server.Of("").In(socketio.Room(quizId.String())).Emit(string(configs.ScoreUpdated), username, leaderboard)
}
